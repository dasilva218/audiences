...
<body style="background-color: #f4f4f4;
    ...
    margin-bottom: 0.20em;">Inscription enregistrée</h1>
            ...
            padding-top: 2em;
            font-size: 1.2rem;">Bonjour {NOM}</p>
            <p style="margin-top: 30px;
            margin-bottom: 20px; font-size: 1.2rem;" class="second-text">
                Votre demande d'audience au {message} a bien été reçu.
            </p>
            <!-- <p style="margin-top: 30px;
            margin-bottom: 20px; font-size: 1.2rem;" class="third-text">
            ...
            <!-- <table style="width: 100%;
                ...
                <td style="padding: 5px;
                        ...
                        text-align: left;
                        font-size: 13px;">
                    <span style=" color: #003366;">Nom</span>
                </td>
                <td style="padding: 5px;
                        border: 1px solid #ccc;
                        text-align: left;
