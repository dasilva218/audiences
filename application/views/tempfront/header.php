                ...
                <div class="container px-8">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                            <li class="nav-item"><a class="nav-link" href="<?=site_url()?>accueil ">Accueil</a></li>
                            <li class="nav-item"><a class="nav-link" href="<?=site_url()?>formulaire">Audience</a></li>
                            <li class="nav-item"><a class="nav-link" href="<?=site_url()?>apropos">A propos</a></li>
                            <li class="nav-item"><a class="nav-link" href="<?=site_url()?>aides">Aide</a></li>
