              ...
              <div class="col-lg-6 border-lg-end">
                <div class="d-flex align-items-center justify-content-between">
                  <div class="d-flex align-items-center">
                    <img class="img-fluid shadow-sm" src="<?= static_url('img/dossier.png') ?>" alt="..." width="50">
                    <div class="ms-3">
                      ...
                      <?php if ($item->accepte == 1) : ?>
                        <p class="text-danger">
                          Accepté
                        </p>
                      <?php elseif ($item->important == 1) : ?>
                        <p class="text-danger">
                          Important
                        </p>
                      <?php elseif ($item->archiver == 1) : ?>
                        <p class="text-danger">
                          Archivé
                        </p>
                      <?php endif ?>
              ...
              <div class="col-lg-6">
                <div class="d-flex align-items-center overflow-hidden">
                  <p class="d-flex mb-0 text-gray-600 text-sm d-flex align-items-center flex-shrink-0 ">
                    <i class="far fa-comment-dots me-1">
